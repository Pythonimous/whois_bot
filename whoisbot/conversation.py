...
def looking_job(update, _):
    ...
    update.message.reply_text('Спасибо, что познакомились!\nТеперь все про тебя знают больше, '
                              ...
                              reply_markup=ReplyKeyboardRemove())
    bot.sendMessage(update.message.chat.id, "Если хочешь поддержать моего автора, "
                                            "пожалуйста, поставь звёздочку здесь:\n"
                                            "⭐️ https://github.com/Pythonimous/whois_bot ⭐️\n"
                                            "Тебе несложно, а мне приятно :) Спасибо! 😊")
